...
order_model = order_namespace.model(
    'Order', {
        ...
        'quantity': fields.Integer(description='Quantity of Pizza')
    }
)
...
class GetUpdateDelete(Resource):
    ...
    def put(self, order_id):
        ...
        order_to_update.quantity = data["quantity"] # or data.quantity
...
class UserOrders(Resource):
    ...
    @order_namespace.doc(
        description='Get all orders by a user by user ID',
        params= {
